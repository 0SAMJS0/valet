        ...
        <div class="section">
                    ...
                    <tr>
                        ...
                        <td>
                            {% if t.status == 'Checked-In' %}
                                <button type="button" class="btn-qr" onclick="openQrModal('{{t.ticketID}}')">View QR</button>
                            {% else %}
                                —
                            {% endif %}
                        </td>
            ...
            <div id="qrModal" class="modal">
                <div class="modal-content">
                    ...
                    <div style="text-align:center;margin-top:14px;">
                        <button onclick="openPrintableQr()">Open Printable QR</button>
                    </div>
                </div>
            </div>
